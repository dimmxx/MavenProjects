...
<form id='registerForm' action='./authservlet' method='post'>
    ...
    <option value='4' <%=(temp != null && temp.equals("4")?"selected":"")%>>Rome, Italy</option></select>

    <br><br><textarea cols='50' rows='7' placeholder='comment' name='comment'><%=(comment!=null?comment:"")%></textarea>
